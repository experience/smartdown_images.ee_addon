...
/**
 * SmartDown Images extension model tests.
 *
...
class Test_smartdown_images_extension_model extends Testee_unit_test_case {
  ...
  {
    parent::setUp();
    $this->_subject = new Smartdown_images_extension_model();
  }
...
/* End of file      : test.smartdown_images_extension_model.php */
/* File location    : third_party/smartdown_images/tests/test.smartdown_images_extension_model.php */
